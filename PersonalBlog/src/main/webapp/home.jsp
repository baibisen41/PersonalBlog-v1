    ...
    <div class="content-wrap">
        <div class="content">
            ...
            <%-- <article class="excerpt-minic excerpt-minic-index">
                 <h2><span class="red"></span><a target="_blank" href="#" title="personalblog">啦啦啦</a>
                 </h2>
                 <p class="note">personalblog，采用DTcms V4.0正式版（MSSQL）。开发环境：SQL2008R2+VS2010。DTcms
            ...
            <div class="title">
                <h3>精选博文</h3>
                <%--<div class="more">
                    <a href="#" title="blogTheme">blogTheme</a>
            ...
            <c:forEach var="blog" items="${blogList}">
                <article class="excerpt excerpt-1" style="">
                    <a class="focus" href="#" title="personalblog" target="_blank"><img class="thumb"
